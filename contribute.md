...
Each GTFO binary is defined in a file in the [`_ptbins/`] folder named as `<binary name>.md`, such file consists only of a [YAML] front matter which describes the binary and its functions.
...
Feel free to use any file in the [`_ptbins/`] folder as an example.
...
[YAML]: https://yaml.org/
[`_ptbins/`]: https://github.com/PTBins/PTBins.github.io/tree/master/_ptbins
[`_data/functions.yml`]: https://github.com/PTBins/PTBins.github.io/blob/master/_data/functions.yml
